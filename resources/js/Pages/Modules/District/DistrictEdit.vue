...
district_code.value = '456';
district_name.value = 'District 02';
...
async function handleSubmit() {
    ...
    formData.append('district_code', first_name.value);
    formData.append('district_name', last_name.value);
                                ...
                                <form class="needs-validation" novalidate @submit.prevent="handleSubmit" ref="formRef">
                                    <div class="form-row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="district_code" required placeholder="District Code" v-model="district_code">
                                        </div>
                                        <div class="col-md-6 mb-3">
