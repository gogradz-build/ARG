...
const consumer_first_name = ref('');
const consumer_last_name = ref('');
const consumer_nic = ref('');
const consumer_contact_number = ref('');
const consumer_address = ref('');
const consumer_email = ref('');
...
async function handleSubmit() {
    ...
    formData.append('consumer_code', first_name.value);
    formData.append('consumer_name', last_name.value);
    ...
    <AdminLayout>
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="m-0">CONSUMER CREATE</h4>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a :href="route('consumer.index')">Consumer</a></li>
                            <li class="breadcrumb-item active">Consumer Create</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        <div class="card card-default">
                            <div class="card-body">
                                <h5 class="w-75 mb-3 text-bold">Consumer Details</h5>
